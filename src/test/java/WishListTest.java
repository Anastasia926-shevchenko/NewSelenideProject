...
public class WishListTest {
    ...
    private final String AUTH_URL = "http://automationpractice.com/index.php?controller=authentication&email=testmail_skup@gmail.com&passwd=12345&back=my-account&SubmitLogin=";
    ...
    public void addToWishListTest() {
        logger.info("open home page and move to summer dresses category");
        open(AUTH_URL);
